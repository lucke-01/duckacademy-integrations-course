...
a persistence unit "EJBPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EJB/pom.xml":
...
artifact ("EJB.war") is already built. You can build
